...
export default {
  ...
  howItWorks: {
    label: 'How It Works',
    title: 'Four Simple Steps with',
    titleHighlight: 'Orbit',
    subtitle: 'From installation to monitoring in less than 24 hours',
    steps: {
      install: { title: 'Installation', description: 'We install tracking devices quickly and professionally without affecting vehicle performance.' },
      connect: { title: 'Connection', description: 'Data flows instantly via secure GPS and GPRS to our cloud platform.' },
      monitor: { title: 'Monitoring', description: 'Monitor your fleet from a smart dashboard or mobile app with interactive maps and reports.' },
      support: { title: 'Support', description: 'Dedicated technical support available 24/7 whenever you need help.' },
    },
  },
  partners: {
    label: 'Our Partners',
