...
export default {
  company: {
    ...
    fullName: 'Orbit Dimension for Technology Solutions',
    ...
    address: 'Riyadh - Al-Mursalat, Abu Bakr Al-Siddiq Road',
  ...
  hero: {
    badge: 'Orbit Dimension — Leaders in Smart Tracking Solutions',
    title: 'Orbit Dimension',
    ...
    alt: {
      fleet: 'Truck fleet GPS tracking in Saudi Arabia',
      dashboard: 'Orbit Dimension fleet management dashboard',
      trucks: 'Truck fleet vehicle tracking',
      schoolBus: 'School bus tracking',
      refrigerated: 'Refrigerated truck temperature monitoring',
    },
  },
  services: {
    label: 'Our Services',
    title: '',
    titleHighlight: 'Orbit Dimension',
    titleEnd: 'Solutions',
