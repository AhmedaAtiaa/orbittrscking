...
import { SERVICE_IDS, goToService } from '../utils/goToService'
...
export default function ServiceDetailPage({ serviceId }) {
  ...
  useEffect(() => {
    ...
    document.title = `${page.title} | ${t('company.name')}`
    return () => {
      document.title = prev
    }
  }, [valid, page, t])
    ...
    return (
      <section className="relative min-h-screen pt-28 pb-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a href="#services" className="text-brand-400 hover:text-brand-300">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="#services" className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-brand-400 px-2">
              {t('servicePages.backServices')}
            </a>
          </div>
        </motion.div>
